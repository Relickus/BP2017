...
public class Constants {
    ...
    public static final String CAPTCHA_SETTINGS_WINDOW = "/view/FXML/CAPTCHASelectFXML.fxml";
    public static final String SOLVER_SETTINGS_WINDOW = "/view/FXML/CAPTCHASelectFXML.fxml";
